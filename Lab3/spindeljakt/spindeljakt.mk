...
ProjectPath            :=/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/spindeljakt
...
ObjectsFileList        :="spindeljakt.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/spindeljakt Debug/spindeljakt.s19
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/spindeljakt > Debug/spindeljakt.lst
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/spindeljakt/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
