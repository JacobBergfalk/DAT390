...
ProjectPath            :=/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/asciidisplay
...
PostBuild:
	...
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/asciidisplay Debug/asciidisplay.s19
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/asciidisplay > Debug/asciidisplay.lst
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/asciidisplay/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
