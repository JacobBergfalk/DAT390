...
ProjectPath            :=/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/movepong
...
PostBuild:
	...
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/movepong Debug/movepong.s19
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/movepong > Debug/movepong.lst
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/movepong/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
