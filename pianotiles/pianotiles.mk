...
##
## Debug
ProjectName            :=pianotiles
ConfigurationName      :=Debug
WorkspacePath          :=/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer
ProjectPath            :=/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/pianotiles
...
ObjectsFileList        :="pianotiles.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/pianotiles Debug/pianotiles.s19
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/pianotiles > Debug/pianotiles.lst
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/pianotiles/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
