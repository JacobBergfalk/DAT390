...
ProjectPath            :=/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/linetest
...
PostBuild:
	...
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/linetest Debug/linetest.s19
	/Applications/codelite.app/Contents/SharedSupport//tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/linetest > Debug/linetest.lst
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "/Users/jacobbergfalk/Desktop/C-programmering/moplaborationer/linetest/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
